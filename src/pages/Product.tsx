...
export function Product(){
    return (
        <div id="product">
            <div className="card product-page-image">
            </div>
            <div className="card product-page-description">
                <span className="title-blue">Nome do produto</span>
                ...
                <div className="product-buy-options">
                    <span className="title product-page-price">RS199,90</span>
